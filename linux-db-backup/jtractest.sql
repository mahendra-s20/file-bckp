...
INSERT INTO `metadata` VALUES (4,7,NULL,NULL,NULL,NULL,'<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<metadata><fields><field name=\"severity\" label=\"Severity\" optional=\"true\"><option value=\"1\">Fatal</option><option value=\"2\">Major</option><option value=\"3\">Minor</option><option value=\"4\">Trivial</option><option value=\"5\">Suggestion</option></field><field name=\"priority\" label=\"Priority\" optional=\"true\"><option value=\"1\">Highest</option><option value=\"2\">High</option><option value=\"3\">Medium</option><option value=\"4\">Low</option><option value=\"5\">Lowest</option></field><field name=\"cusInt01\" label=\"Activity Type\" optional=\"true\"><option value=\"1\">Quarrel days. She quarreled inFRNTof guardian</option><option value=\"2\">She tried to provoke me to slap</option><option value=\"3\">She did not eat or less eat</option><option value=\"4\">She talked to stranger</option><option value=\"5\">She ignored my suggestion</option><option value=\"6\">For her pleasure.Favor on her</option><option value=\"7\">She blaims</option><option value=\"8\">Her parents\' sin</option></field><field name=\"cusTim01\" label=\"TargetDate\" optional=\"true\"/><field name=\"cusTim02\" label=\"Activity Date\" optional=\"true\"/><field-order><field name=\"severity\"/><field name=\"priority\"/><field name=\"cusTim01\"/><field name=\"cusInt01\"/><field name=\"cusTim02\"/></field-order></fields><roles><role name=\"DEFAULT\"><state status=\"0\"><transition status=\"1\"/><field name=\"cusTim01\" mask=\"3\"/><field name=\"cusTim02\" mask=\"3\"/><field name=\"cusInt01\" mask=\"3\"/><field name=\"severity\" mask=\"3\"/><field name=\"priority\" mask=\"3\"/></state><state status=\"1\"><transition status=\"1\"/><transition status=\"2\"/><transition status=\"99\"/><transition status=\"3\"/><field name=\"cusTim01\" mask=\"2\"/><field name=\"cusTim02\" mask=\"2\"/><field name=\"cusInt01\" mask=\"2\"/><field name=\"severity\" mask=\"2\"/><field name=\"priority\" mask=\"2\"/></state><state status=\"2\"><transition status=\"1\"/><transition status=\"2\"/><transition status=\"3\"/><transition status=\"99\"/><field name=\"cusTim01\" mask=\"2\"/><field name=\"cusTim02\" mask=\"2\"/><field name=\"cusInt01\" mask=\"2\"/><field name=\"severity\" mask=\"2\"/><field name=\"priority\" mask=\"2\"/></state><state status=\"99\"><transition status=\"1\"/><transition status=\"2\"/><transition status=\"99\"/><transition status=\"3\"/><field name=\"cusTim01\" mask=\"2\"/><field name=\"cusTim02\" mask=\"2\"/><field name=\"cusInt01\" mask=\"2\"/><field name=\"severity\" mask=\"2\"/><field name=\"priority\" mask=\"2\"/></state><state status=\"3\"><transition status=\"1\"/><transition status=\"2\"/><transition status=\"3\"/><transition status=\"99\"/><field name=\"cusTim01\" mask=\"2\"/><field name=\"cusTim02\" mask=\"2\"/><field name=\"cusInt01\" mask=\"2\"/><field name=\"severity\" mask=\"2\"/><field name=\"priority\" mask=\"2\"/></state></role></roles><states><state status=\"0\" label=\"New\"/><state status=\"1\" label=\"Open\"/><state status=\"2\" label=\"In-Progress\"/><state status=\"3\" label=\"On-Hold\"/><state status=\"99\" label=\"Closed\"/></states></metadata>');
...
INSERT INTO `space_sequence` VALUES (4,5);
...
-- Dump completed on 2021-04-02 20:03:49
